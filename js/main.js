...
getRandomDecimal(1, 5);

getRandomFloat(1.1, 6.6, 2);
...
const TITLES = ['Выгодное', 'Заманчивое', 'Замечательное', 'Великолепное', 'Горячее', 'Супер'];
const DESCRIPTIONS = ['Роскошное', 'Комфортабельное', 'Современное', 'Удобно расположенное', 'Уютное'];
